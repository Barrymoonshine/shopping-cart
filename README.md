...
- **useReducer** to centrally manage state using a reducer function containing a switch statement to provide explicit control over what action is being carried out, and a global ACTIONS variable to eliminate the need to hard-code switch cases and the risk of inconsistencies and errors across files
